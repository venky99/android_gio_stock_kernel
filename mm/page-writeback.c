...
unsigned int dirty_writeback_interval, resume_dirty_writeback_interval, suspend_dirty_writeback_interval = 2000;

/*
 * The longest time for which data is allowed to remain dirty
 */
#define DEFAULT_DIRTY_EXPIRE_INTERVAL 300 /* centiseconds */
unsigned int dirty_expire_interval, resume_dirty_expire_interval, suspend_dirty_expire_interval = 1000;
